...
EOF
  ...
  qsub -W group_list=vaccine -A vaccine -p 1 -m e -l nodes=1:gpus=1:ppn=20,mem=80gb,walltime=${1} "/home/projects/vaccine/people/yatwan/tclustr/bashscripts/${filename}.sh"
