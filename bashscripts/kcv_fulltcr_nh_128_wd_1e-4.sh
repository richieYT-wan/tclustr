...
outname="FullTCR_nh_128_wd_1e-4_weights_3to1"
...
filename=${filename}
cd \${PYDIR}
python3 ./fulltcr_vae.py -f /home/projects/vaccine/people/yatwan/tclustr/data/filtered/230927_nettcr_positives_only.csv -pad -20 -enc BL50LO-ne 25000 -lwseq 3 -lwkld 1 -nl 64 -nh 128 -lr 5e-4 -wd 1e-4 -wu 15 -o ${outname} -rid ${random_string} -kf ${f} -seed ${f}
EOF
)
