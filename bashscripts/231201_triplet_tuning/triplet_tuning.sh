...
margins=(0.05 0.1 0.15 0.2 5 10 15 20)
triplets=("cosine" "cosine" "cosine" "cosine" "l2" "l2" "l2" "l2")
nlatents=(32 64)
wtrps=(0.5 0.75 1)
wklds=(1 0.1 0.01)
...
filename=${filename}
cd \${PYDIR}
python3 ./231102_fulltcr_tripletloss.py -f /home/projects/vaccine/people/yatwan/tclustr/data/filtered/230927_nettcr_positives_only.csv -pad -20 -enc BL50LO -ne 27500 -cuda True -lwseq 3 -lwkld ${wkld} -lwtrp ${wtrp} -dist_type ${triplets[i]} -margin ${margins[i]} -mla1 0 -mla2 0 -mlb1 0 -mlb2 0 -nl ${nl} -nh $((nl * 2)) -bs 512 -lr 1.75e-4 -wd 1e-4 -wu 10 -o ${outname} -rid ${random_string} -kf ${f} -seed ${f}
EOF
)
