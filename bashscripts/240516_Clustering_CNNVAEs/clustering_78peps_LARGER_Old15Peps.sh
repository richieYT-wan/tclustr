...
python3 ./240420_VAE_Clustering_intervals.py -np 500 -kf 0 -o ${iid}_CNNVAE_78peps_LARGER -od ../output/240516_TripletTweaks_IntervalClustering/ -tbcralign ${tbcralign} -tcrdist ${tcrdist} -f ${idf} -model_folder ${model_folder} -rb True -n_jobs 40 -dn ${iid} -bf ../output/240515_IntervalClustering
