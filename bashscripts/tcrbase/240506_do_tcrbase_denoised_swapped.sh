...
mainfolder=/Users/riwa/Documents/code/tclustr/output/240429_KLweights/
outdir=/Users/riwa/Documents/code/tclustr/output/240429_KLweights/TCRBASE_ValidSwap/
grepst=$1
grepv=$2
...
for fullpath in ${subdir}; do
    ...
    echo "python3 ./do_tcrbase_swaps.py -model_folder "${fullpath}/" -rid ${random_id} -od ${outdir} -o "tcrbase_${name_description}" -db /Users/riwa/Documents/code/tclustr/data/filtered/240506_reconcat_aggcluster_filtered_df_17peps_with_p0swaps.csv -kf ${kfold_number}"

    python3 ./do_tcrbase_swaps.py -model_folder "${fullpath}/" -rid ${random_id} -od ${outdir} -o "tcrbase_${name_description}" -db /Users/riwa/Documents/code/tclustr/data/filtered/240506_reconcat_aggcluster_filtered_df_17peps_with_p0swaps.csv -kf ${kfold_number}
    echo "####################"
done
