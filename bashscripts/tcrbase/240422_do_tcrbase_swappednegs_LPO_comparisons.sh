...
mainfolder=/Users/riwa/Documents/code/tclustr/output/240419_TripletLPO/
outdir=/Users/riwa/Documents/code/tclustr/output/240419_TripletLPO/tcrbase_output/
grepst=$1
subdir=$(ls -dr ${mainfolder}/*/ | grep -v tcrbase | grep ${grepst})
mkdir -p ${outdir}
