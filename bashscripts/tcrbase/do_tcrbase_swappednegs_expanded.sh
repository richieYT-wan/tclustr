...
for fullpath in ${subdir}; do
    ...
    echo "python3 ./do_tcrbase_swaps.py -model_folder "${fullpath}/" -rid ${random_id} -od ${2} -o "tcrbase_${name_description}" -db ../data/multimodal/240326_nettcr_paired_withswaps.csv -kf ${kfold_number}"

    python3 ./do_tcrbase_swaps.py -model_folder "${fullpath}/" -rid ${random_id} -od ${2} -o "tcrbase_${name_description}" -db ../data/multimodal/240326_nettcr_paired_withswaps.csv -kf ${kfold_number}
    echo "####################"
done
