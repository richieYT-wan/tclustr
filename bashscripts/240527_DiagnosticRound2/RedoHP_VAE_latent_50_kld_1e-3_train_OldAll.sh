...
outname=RedoHP_VAE_latent_50_kld_1e-3_train_OldAll

# Run VAE
python3 ./231102_fulltcr_tripletloss.py -f ${HOMEDIR}data/filtered/240416_nettcr_old_26pep_no_swaps.csv -od ${outdir} -pad -20 -enc BL50LO -ne 20000 -cuda True -lwseq 1 -lwkld 1e-3 -lwtrp 3 -dist_type cosine -margin 0.2 -mla1 7 -mla2 8 -mla3 22 -mlb1 6 -mlb2 7 -mlb3 23 -mlpep 0 -nl 50 -nh 128 -bs 512 -lr 1e-4 -wd 1e-4 -wu 150 -fp 50 -kld_dec 1e-2 -kldts 0.075 -o ${outname} -kf 0 -seed 0 -addpe True -bn True -ale True -ald True -ob False -pepweight False -posweight True -rid ${random_id}
...
# Run clustering part
python3 ./240420_VAE_Clustering_intervals.py -rid ${random_id} -np 500 -kf 0 -o ${outname}_${iid} -od ../output/${outdir}/clustering/ -tbcralign /home/projects/vaccine/people/yatwan/tclustr/output/240411_ClusteringTests/dist_matrices/2404XX_OUTPUT_tbcralign_distmatrix_26peps_labeled.csv -tcrdist /home/projects/vaccine/people/yatwan/tclustr/output/240411_ClusteringTests/dist_matrices/tcrdist3_distmatrix_26peps_old_labeled.csv -f ${idf} -model_folder "${RESDIR}/${outmatch}" -rb True -n_jobs 40 -dn ${iid} -bf ../output/240515_IntervalClustering
outmatch=$(ls -t ${RESDIR} | grep ${random_id} | head -n 1)
iid=OldDataNoPrune
...
outmatch=$(ls -t ${RESDIR} | grep ${random_id} | head -n 1)
iid=OldDataTop15
idf=/home/projects/vaccine/people/yatwan/tclustr/data/filtered/240416_nettcr_old_top15peps_no_swaps.csv
# Run clustering part
python3 ./240420_VAE_Clustering_intervals.py -rid ${random_id} -np 500 -kf 0 -o ${outname}_${iid} -od ../output/${outdir}/clustering/ -tbcralign /home/projects/vaccine/people/yatwan/tclustr/output/240411_ClusteringTests/dist_matrices/2404XX_OUTPUT_tbcralign_distmatrix_26peps_labeled.csv -tcrdist /home/projects/vaccine/people/yatwan/tclustr/output/240411_ClusteringTests/dist_matrices/tcrdist3_distmatrix_26peps_old_labeled.csv -f ${idf} -model_folder "${RESDIR}/${outmatch}" -rb True -n_jobs 40 -dn ${iid} -bf ../output/240515_IntervalClustering
