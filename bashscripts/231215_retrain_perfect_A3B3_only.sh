...
filename=${filename}
cd \${PYDIR}
python3 ./fulltcr_vae.py -f /home/projects/vaccine/people/yatwan/tclustr/data/filtered/230927_nettcr_positives_only.csv -pad -20 -enc BL50LO -ne 30000 -lwseq 10 -mla1 0 -mla2 0 -mlb1 0 -mlb2 0 -lwkld 1e-4 -nl 128 -nh 256 -lr 1e-4 -wd 1e-6 -wu 100 -o ${outname} -rid ${random_string} -kf ${f} -seed ${f}
EOF
)
