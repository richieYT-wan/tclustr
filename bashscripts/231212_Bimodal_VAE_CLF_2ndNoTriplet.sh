...
outname="231211_Bimodal_VAE_CLF_2ndRun_NoTriplet"
...
EOF
                              ...
                              qsub -W group_list=vaccine -A vaccine -m e -p 1 -l nodes=1:gpus=1:ppn=20,mem=120gb,walltime=${1} "/home/projects/vaccine/people/yatwan/tclustr/bashscripts/${filename}.sh"
