...
python3 ./240420_VAE_Clustering_intervals.py -np 500 -kf 0 -o TripletTweak_Expanded_CDFalse_WUTrue_SamplerFalse_P0N1_ -od ../output/240516_TripletTweaks_IntervalClustering/ -tbcralign ${tbcralign} -tcrdist ${tcrdist} -f ${idf} -model_folder ${model_folder}
