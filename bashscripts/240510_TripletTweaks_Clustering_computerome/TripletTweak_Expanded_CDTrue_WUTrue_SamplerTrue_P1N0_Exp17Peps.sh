...
python3 ./240420_VAE_Clustering_intervals.py -np 400 -kf 0 -o ${iid}_TripletTweak_Expanded_CDTrue_WUTrue_SamplerTrue_P1N0 -od ../output/240516_TripletTweaks_IntervalClustering/${iid} -tbcralign ${tbcralign} -tcrdist ${tcrdist} -f ${idf} -n_jobs 40 -dn ExpData17peps -rb True -bf ../output/240515_IntervalClustering/ -model_folder ${model_folder}
