...
python3 ./240420_VAE_Clustering_intervals.py -np 400 -kf 0 -o TripletTweak_Expanded_CDTrue_WUTrue_SamplerTrue_P1N0 -od ../output/240516_TripletTweaks_IntervalClustering/ -tbcralign ${tbcralign} -tcrdist ${tcrdist} -f ${idf} -n_jobs 40 -dn ExpDataTop78 -rb True -bf ../output/240515_IntervalClustering/ -model_folder ${model_folder}
