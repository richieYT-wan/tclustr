...
python3 ./240420_VAE_Clustering_intervals.py -np 400 -kf 0 -o TripletTweak_OldPruned_CDTrue_WUFalse_SamplerFalse_P0N1 -od ../output/240516_TripletTweaks_IntervalClustering/ -tbcralign ${tbcralign} -tcrdist ${tcrdist} -f ${idf} -n_jobs 40 -model_folder ${model_folder}
