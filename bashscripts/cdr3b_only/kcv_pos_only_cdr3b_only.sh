...
outname="OnlyPositivesFullCDR3b_LowerDim_64"
...
filename=${filename}
cd \${PYDIR}
python3 ./vae_cdr3_vj.py -f /home/projects/vaccine/people/yatwan/tclustr/data/filtered/230927_nettcr_positives_only.csv -pad -20 -enc BL50LO -ml 25 -ne 1500 -lwseq 3 -lwkld 2 -cdr3b "TRB_CDR3" -v "None" -j "None" -nl 64 -nh 100 -lr 1e-4 -wd 1e-2 -o ${outname} -rid ${random_string} -kf ${f} -seed ${f}
EOF
)
