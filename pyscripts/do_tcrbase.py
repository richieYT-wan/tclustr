...
def do_histplot(dist_matrix, peptide, unique_filename, outdir):
    ...
    sns.histplot(data=ntr, x='distance', hue='label', ax=a, kde=False, stat='percent', common_norm=False, bins=300,
                 alpha=0.75)
