...
def main():
    ...
    dataset_init_code = FullTCRDataset.__init__.__code__
    dataset_init_code = FullTCRDataset.__init__.__code__.co_varnames[1:dataset_init_code.co_argcount]
    ...
    if args['test_file'] is not None:
        ...
        test_dataset = FullTCRDataset(test_df, **dataset_params)
        ...
        print(f'Final valid reconstruction accuracy: \t{test_seq_acc:.3%}')
    else:
        test_seq_acc = None
