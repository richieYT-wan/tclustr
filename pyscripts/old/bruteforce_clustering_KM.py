...
def bruteforce(n_clusters, ODIR, z_train_30k, z_valid_30k, z_gil_30k, train_preds_30k, valid_preds_30k, gil_preds_30k):
    ...
    train_summary['metric'] = 'KMeans'
    train_summary['hp'] = n_clusters
    train_df['metric'] = 'KMeans'
    train_df['hp'] = n_clusters
    valid_summary['metric'] = 'KMeans'
    valid_summary['hp'] = n_clusters
    valid_df['metric'] = 'KMeans'
    valid_df['hp'] = n_clusters
    gil_summary['metric'] = 'KMeans'
    gil_summary['hp'] = n_clusters
    gil_df['metric'] = 'KMeans'
...
ntm = partial(bruteforce, ODIR=ODIR, train_preds_30k=train_preds_30k, valid_preds_30k=valid_preds_30k,
              gil_preds_30k=gil_preds_30k, z_gil_30k=z_gil_30k, z_train_30k=z_train_30k, z_valid_30k=z_valid_30k)
Parallel(n_jobs=36)(delayed(ntm)(n_clusters=n_clusters) for n_clusters in tqdm(range(2, 50), desc='n_clst', position=0, leave=True))
end = dt.now()
